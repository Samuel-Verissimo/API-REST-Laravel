...
<script>
    function onSwaggerLoadComplete() {
        const elements = document.querySelectorAll("[data-tag='Produtos']");
        const isClosedElements = document.querySelectorAll("[data-is-open='false']");
        
        if (elements.length > 0) {
            isClosedElements.forEach((element) => {
                element.click();  
            });
        }

        document.querySelector('.filter-container').style.display = 'none';
        document.querySelector('.url').textContent = 'https://github.com/coodesh/products-parser-20230105';
    }
